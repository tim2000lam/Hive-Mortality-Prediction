#Pipeline for SVM regression model on EPILOBEE dataset
#Timothy Lam (tlam04@uoguelph.ca), Samantha Share (sshare@uoguelph.ca)
#How to run: python3, SVM_model_Optimized.py
...
pyplot.title("SVM: Number of predictor variables \n comparison, before optimization")

pyplot.savefig('SVM_before.png')
...
for i in number_of_features:
    ...
    ax.set_title("Learning Curve SVM, Number of features: " + str(i)) #I changed this so the learning curve title includes the number of features 
    ...
    fig_name = "SVM_LC_before_+" +str(i) +".png"
    
    pyplot.savefig(fig_name)
    
###Hyperparameter optimization 
#Set the parameters
parameters = {'C': [1, 5], 'gamma': [1, 5], 'epsilon': [0.1, 0.3], 'degree': [2, 4]}
...
for i in number_of_features:
    ...
    #Plot learning curves
    fig, ax = pyplot.subplots()
    ax.set_title("Learning Curve SVM Post Optimization,\n Number of features: " + str(i))
    ax.set_xlabel("Training Examples")
    ax.set_ylabel("Score")
    ax.grid()
    ...
    fig_name = "SVM_LC_after_+" +str(i) +".png"
